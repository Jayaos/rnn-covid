...
def train_mlp_kfold(output_path, patient_record_path, demo_record_path, labels_path, max_epoch, batch_size,
                input_vocabsize, demo_vocabsize, embedding_dim, hidden_units, l2_reg=0.001, learning_rate=0.00001, k=5, pretrained_embedding=None):
...
if __name__ == "__main__":
    ...
    args.batch_size, args.input_vocabsize, args.demo_vocabsize, args.hidden_units, args.embedding_dim, args.l2_reg, 
