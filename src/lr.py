...
def parse_arguments(parser):
    ...
    parser.add_argument("--input_vocabsize", type=int, help="The number of unique concepts in the training data")
...
if __name__ == "__main__":
    ...
    train_lr_kfold(args.output, args.input_record, args.input_demo, args.input_label, args.max_epoch,
    args.batch_size, args.input_vocabsize, args.demo_vocabsize, args.l2_reg, args.learning_rate, args.k)